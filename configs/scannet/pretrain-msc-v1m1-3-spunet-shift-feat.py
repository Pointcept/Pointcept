...
data = dict(
    ...
    train=dict(
        ...
        transform=[
            ...
            dict(type="ContrastiveViewsGenerator", view_keys=("coord", "color", "normal"), view_trans_cfg=[
            ...
            dict(type="ToTensor"),
            dict(type="Collect",
                 keys=("view1_origin_coord", "view1_discrete_coord", "view1_coord", "view1_color", "view1_normal",
                       "view2_origin_coord", "view2_discrete_coord", "view2_coord", "view2_color", "view2_normal"),
                 offset_keys_dict=dict(view1_offset="view1_coord", view2_offset="view2_coord"),
                 view1_feat_keys=("view1_normal", "view1_color"),
                 view2_feat_keys=("view2_normal", "view2_color"))
        ],
        test_mode=False
    )
)
