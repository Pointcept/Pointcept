...
# misc custom setting
save_path = "exp/tomato_gs2pc/spunet_gs2pc_200k_organ_expert_fused_boundary"
batch_size = 4
num_worker = 8
mix_prob = 0.8
empty_cache = False
...
# Organ expert + gate residual fuse + boundary-aware auxiliary loss (on fused logits)
model = dict(
