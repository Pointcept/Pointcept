...
data = dict(
    num_classes=25,
    ignore_index=-1,
    names=("wall", "floor", "cabinet", "bed", "chair", "sofa", "table", "door", "window", "picture", "desk",
    ...
    train=dict(
        ...
        transform=[
            ...
            dict(type="ToTensor"),
            dict(type="Collect", keys=("coord", "discrete_coord", "segment"), feat_keys=("coord", "color", "normal"))
        ],
        test_mode=False
    ),
    ...
    test=dict(
        ...
        test_cfg=dict(
            ...
            post_transform=[
                dict(type="CenterShift", apply_z=False),
                dict(type="ToTensor"),
                dict(type="Collect", keys=("coord", "discrete_coord", "index"), feat_keys=("coord", "color", "normal"))
            ],
            aug_transform=[
