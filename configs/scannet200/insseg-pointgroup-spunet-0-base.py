...
hooks = [
    ...
    dict(type="InsSegEvaluator", num_classes=num_classes, class_names=class_names, segment_ignore_index=(-1, 0, 2)),
...
data = dict(
    ...
    train=dict(
        ...
        transform=[
            ...
            dict(type="InstanceParser", segment_ignore_index=(-1, 0, 2), instance_ignore_index=-1),
            dict(type="ToTensor"),
            dict(type="Collect",
