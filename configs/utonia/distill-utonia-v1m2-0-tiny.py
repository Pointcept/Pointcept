...
model = dict(
    ...
    backbone_out_channels=468,
    enc2d_upcast_level=3,  # backbone - student & teacher
    backbone_s=dict(
        type="PT-v3m3",
        in_channels=9,
        ...
        enc_channels=(18, 36, 72, 144, 216),
        enc_num_head=(1, 2, 4, 8, 12),
