...
if __name__ == '__main__':
    ...
    # Load label map
    labels_pd = pd.read_csv('pointcept/datasets/preprocessing/scannet/meta_data/scannetv2-labels.combined.tsv',
                            sep='\t', header=0)

    # Load train/val splits
    with open('pointcept/datasets/preprocessing/scannet/meta_data/scannetv2_train.txt') as train_file:
        train_scenes = train_file.read().splitlines()
    with open('pointcept/datasets/preprocessing/scannet/meta_data/scannetv2_val.txt') as val_file:
