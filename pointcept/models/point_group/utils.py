...
class BallQueryBatchP(Function):
    ...
    def forward(ctx, coords, batch_idxs, batch_offsets, radius, meanActive):
        ...
        while True:
            ...
            nActive = pointgroup_ops.ballquery_batch_p(coords, batch_idxs, batch_offsets, idx, start_len, n, meanActive, radius)
...
class BFSCluster(Function):
    ...
    def forward(ctx, semantic_label, ball_query_idxs, start_len, threshold):
        ...
        pointgroup_ops.bfs_cluster(semantic_label, ball_query_idxs, start_len, cluster_idxs, cluster_offsets, N, threshold)
